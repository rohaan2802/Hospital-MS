-- MySQL 8+ schema and demo data for Aiven MySQL.
-- Run this file against the database selected in Aiven's connection details.
...
-- â”€â”€ STAFF (14 doctors/consultants + 15 nurses = 29) 
